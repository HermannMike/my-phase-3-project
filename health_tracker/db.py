...
from .models import Base # Changed to relative import
...
if __name__ == "__main__":
    # This block allows running `python -m health_tracker.db` to initialize
    print(f"Initializing database (via __main__) at {DATABASE_URL}...")
    init_db()
    print("Database initialized successfully (via __main__). Tables created (if they didn't exist).")